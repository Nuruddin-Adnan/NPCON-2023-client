...
export default function Navbar() {
  ...
  return (
    <div className="container mx-auto">
      <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 md:py-0 dark:bg-gray-800 dark:border-gray-700">
        <nav
          className="relative max-w-7xl w-full mx-auto px-4 md:flex md:items-center md:justify-between md:px-6 lg:px-8"
          aria-label="Global"
        >
          ...
          >
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:pl-7">
              {/* {user && user.role! === ("rent_collector" || "admin") && ( */}
              {user &&
                (user.role! === "rent_collector" || user.role! === "admin") && (
                  <NavLink
              ...
              {user && (
                <div className="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--trigger:hover] md:py-4 [--placement:bottom-right]">
                  <button
                    type="button"
